...
export default class CustomMedicineSearch extends Component {
	static defaultProps = {
		defaultValue: '',
	...
	renderItem = () => ({ item }) => {
		...
		return (
			<TouchableOpacity
				...
				style={{
					backgroundColor: item.stockOnHand === 0 ? '#d63031' : 'transparent',
				}}
			>
				<View
					style={{
				...
				>
					<Text
						style={{
							fontWeight: 'bold',
							color: item.stockOnHand === 0 ? '#fbfaff' : '#2c3e50',
						}}
					>
						{item[fieldName]}
					</Text>
